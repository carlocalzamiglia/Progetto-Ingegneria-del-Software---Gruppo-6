               ...
               switch (serialnumber) {
                   ...
                   case 4:
                       ...
                       if (ruler.schemeCount(player.getScheme()) >= 2) {
                           ...
                           System.out.println("dadi insufficienti per l'utilizzo della carta");
                       break;
                   ...
                   case 5:
                       ...
                       try5 = greenCarpet.checkEmptyRoundpath();
                       if (try5) {
                           while (try5) {
                               System.out.println("scegli dado dal tracciato dei round");
                               row = scan.nextInt();
                               col = scan.nextInt();
                           ...
                           correct = !ruler.checkAvailableDice(dice5, player.getScheme());
                           if (correct) {
                               System.out.println("dado non piazzabile nello schema\n dado aggiunto alla riserva");
                               greenCarpet.setDiceInStock(dice5);
                           }
                           while (!correct) {
                               System.out.println("Scegli le coordinate di inserimento");
                               row = scan.nextInt();
                           ...
                           System.out.println("tracciato dei round vuoto carta non utilizzabile");
                           greenCarpet.setDiceInStock(dice5);
                       }
                       break;
                   case 6:
                   ...
                   case 9:
                       ...
                       int d9 = 0;
                       Dice dice9;
                       try9 = ruler.checkRulesTool9(greenCarpet, player);
                       if (try9) {
                           while (try9) {
                               System.out.println("Scegli un dado \n");
                               d9 = scan.nextInt();
                               if (d9 < greenCarpet.getStock().size() + 1 && d9 > 0) {
                                   ...
                                   for (int k = 0; k <= 3 && try9; k++)
                                       for (int x = 0; x <= 4 && try9; x++)
                                           if (ruler.checkEmptyNeighbors(k, x, player.getScheme())) {
                                               if (player.getScheme().getBox(k, x).getRestrictionColour() != null)
                                                   try9 = !player.getScheme().getBox(k, x).getRestrictionColour().equals(dice9.getColour());
                                               else if (player.getScheme().getBox(k, x).getRestrictionValue() != null)
                                                   try9 = !player.getScheme().getBox(k, x).getRestrictionValue().equals(faceToNo(dice9.getFace()));
                                               else
                                                   try9 = false;
                                           }
                               }
                           ...
                           System.out.println("nessun dado rispetta le restrizioni della carta strumento");
                       break;
                   ...
                   case 12:
                       boolean try12;
                       try12 = !greenCarpet.checkEmptyRoundpath();
                       if (!try12) {
                           while (!try12) {
                               System.out.println("scegli dado dal tracciato dei round");
                               col = scan.nextInt();
                           ...
                           int colTmp121 = 0;
                           int colTmp122 = 0;
                           correct=player.getScheme().isEmpty();
                           if (!correct) {
                               while (!correct) {
